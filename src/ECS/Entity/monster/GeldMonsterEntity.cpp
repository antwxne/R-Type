...
#include "GeldMonsterEntity.hpp"

GeldMonsterEntity::GeldMonsterEntity() : IEntityRegister()
{
}

GeldMonsterEntity::~GeldMonsterEntity()
{
}

void GeldMonsterEntity::create(const std::shared_ptr<ComponentManager> &componentManager, const std::shared_ptr<EntityManager> &entityManager)
{
...
{
    return std::shared_ptr<IEntityRegister>(new GeldMonsterEntity());
}